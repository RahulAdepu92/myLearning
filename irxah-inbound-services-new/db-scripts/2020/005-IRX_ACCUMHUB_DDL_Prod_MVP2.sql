...
/*==============================================================*/
/* Drop existing table in AHUB_STG.STG_ACCUM_DTL	            */
/*==============================================================*/

DROP TABLE IF EXISTS AHUB_STG.STG_ACCUM_DTL;
...
CREATE TABLE IF NOT EXISTS ahub_dw.client_files (
	...
	alert_notification_arn varchar(200),
